...
<header id="main-header" class="fixed w-full z-50 transition-all duration-500">
    ...
    <!-- Seção de Serviços com vídeo de fundo -->
...
<!-- Modal de resultado do formulário de contato -->
<div id="modal-overlay" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 hidden">
    ...
    <!-- Script de animação ao scroll utilizando Intersection Observer API -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Callback executado quando elementos entram na viewport
            ...
            // Cria o observador e monitora elementos com classe js-scroll-animate
