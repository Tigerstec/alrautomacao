...
<head>
    ...
    <!-- =======================================
        CABEÇALHO / HEADER - Menu de Navegação
        ========================================
    -->
    <header id="main-header" class="fixed w-full z-50 transition-all duration-500">
        <div id="header-container" class="opacity-90 !bg-light border-2 border-black max-w-7xl mx-auto px-4 py-4 mt-4 -black rounded-3xl text-white shadow-md transition-all duration-500">
            ...
            <!-- Menu mobile (inicialmente oculto - classe 'hidden') -->
        ...
        <div class="container mx-auto px-4">
            <div class="text-center mb-16 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Conheça a ALR Automações Industrial, referência em soluções tecnológicas para o setor industrial.
                </p>
            </div>
            
            <!-- Conteúdo principal: Ilustração + Textos -->
            <div class="flex flex-col md:flex-row items-center js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out">
                ...
                <!-- Coluna esquerda: Ilustração SVG -->
                <div class="md:w-1/2 mb-10 md:mb-0 md:pr-10">
                    <div class="relative">
                        <!-- Círculo decorativo de fundo (posição absoluta atrás do SVG) -->
                        <div class="bg-primary w-64 h-64 rounded-full absolute -z-10 -top-6 -left-6"></div>
                        
                        <!-- SVG customizado representando automação industrial -->
                        <svg class="w-full max-w-lg mx-auto" viewBox="0 0 600 400" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!-- Barras decorativas inferiores (representando controles) -->
                ...
                <!-- Coluna direita: Textos informativos -->
                <div class="md:w-1/2">
                    <!-- História da empresa -->
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Nossa História</h3>
                    <p class="text-gray-600 mb-6">
                        A ALR Automações Industrial nasceu da paixão por tecnologia e inovação. Há mais de 15 anos no mercado, nos especializamos em desenvolver soluções personalizadas que otimizam processos industriais, reduzem custos operacionais e aumentam a produtividade de nossos clientes.
                    </p>
                    
                    <!-- Missão da empresa -->
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">Nossa Missão</h3>
                    <p class="text-gray-600 mb-6">
                        Fornecer soluções tecnológicas inovadoras e confiáveis em automação industrial, contribuindo para o crescimento sustentável de nossos clientes através da excelência técnica e compromisso com resultados.
                    </p>
                    
                    <!-- Grid de diferenciais com checkmarks -->
                    <div class="grid grid-cols-2 gap-4 mb-8">
                        <!-- Item 1 -->
                        <div class="flex items-center">
                            <!-- Ícone de check dentro de círculo laranja -->
    ...
    <!-- ========================================
        SEÇÃO SERVIÇOS
        ========================================
        Apresenta os principais serviços da empresa com:
        - Vídeo de fundo em loop (alr.mp4) com overlay escuro
        - Grid de cards de serviços
        - Ícones SVG ilustrativos para cada serviço
        - Animações em cascata (transition-delay) nos cards
    -->
    <section id="servicos" class="relative py-20 overflow-hidden">
        
        <!-- Background com vídeo -->
        <!-- Camada de vídeo e overlay para criar efeito visual atraente -->
        <div class="absolute inset-0 z-0">
            <!-- Vídeo em autoplay, loop e mudo como background -->
            ...
            <!-- Overlay escuro semi-transparente sobre o vídeo -->
            <!-- opacity-50 = 50% de opacidade para garantir legibilidade do texto -->
            <div class="absolute inset-0 bg-black opacity-50"></div>
        </div>

        <!-- Conteúdo da seção (z-10 garante que fique acima do vídeo) -->
        <div class="container relative z-10 mx-auto px-4">
            ...
            <div class="text-center mb-16 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out">
                ...
                <p class="text-xl text-gray-200 max-w-3xl mx-auto">
                    Oferecemos soluções completas em automação industrial para otimizar seus processos e aumentar sua produtividade.
                </p>
            </div>
            
            <!-- Grid de cards de serviços -->
            <!-- Grid responsivo: 1 coluna em mobile, 2 em desktop (md:grid-cols-2) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div class="service-card bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out">
                    <!-- Cabeçalho do card com ícone SVG -->
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            Desenvolvimento e implementação de sistemas automatizados para otimizar processos industriais, reduzir custos e aumentar a eficiência operacional.
                        </p>
                    </div>
                </div>
                
                <!-- Card 2: Sistemas de Controle -->
                <!-- style="transition-delay: 150ms" cria efeito de cascata nas animações -->
                <div class="service-card bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out" style="transition-delay: 150ms;">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            Projeto e implementação de sistemas de controle industrial, incluindo CLPs, IHMs, SCADA e sistemas de supervisão para monitoramento em tempo real.
                        </p>
                    </div>
                </div>
                ...
                <div class="service-card bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out" style="transition-delay: 300ms;">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            Integração de sistemas legados com novas tecnologias, permitindo a comunicação eficiente entre diferentes equipamentos e plataformas.
                        </p>
                    </div>
                </div>
                
                <!-- Card 4: Manutenção Preditiva -->
                <div class="service-card bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out" style="transition-delay: 450ms;">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">
                            Implementação de sistemas de monitoramento e análise para prever falhas em equipamentos, reduzindo paradas não programadas e custos de manutenção.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- ========================================
        ...
        ========================================
        Galeria de projetos concluídos pela empresa.
        Grid responsivo com 6 projetos destacados de diferentes clientes industriais.
        Cada card possui: imagem, título, descrição técnica e data de conclusão.
    -->
    <section id="projetos" class="py-20 bg-gray-50 overflow-hidden">
        <div class="container mx-auto px-4">
            ...
            <!-- Grid de projetos: 1 coluna (mobile), 2 colunas (tablet), 3 colunas (desktop) -->
    ...
    <!-- ========================================
        ...
        - Container flexível (#testimonial-container) manipulado via JavaScript
        - Botões de navegação (prev/next) com IDs específicos
        - Cards de depoimentos com estrelas de avaliação
        - Implementação de carrossel horizontal com transições CSS
    -->
    <section class="py-20 bg-white overflow-hidden">
        <div class="container mx-auto px-4">
            ...
            <!-- Container do carrossel com posicionamento relativo para os botões -->
            <div class="relative js-scroll-animate opacity-0 translate-y-5 transition-all duration-700 ease-out">
                <div class="overflow-hidden">
                    ...
                    <!-- ID 'testimonial-container' é manipulado pelo JavaScript em index.js -->
                    <!-- A propriedade transform é alterada para deslizar os depoimentos -->
            ...
            <!-- Posicionados absolutamente em relação ao container relativo -->
            <!-- ID 'prev-testimonial' - manipulado pelo JavaScript para navegar para depoimento anterior -->
            ...
            <!-- ID 'next-testimonial' - manipulado pelo JavaScript para navegar para próximo depoimento -->
    ...
    <!-- ========================================
        ...
        ========================================
        Formulário de contato com background hero.
        Elementos importantes:
        - form ID 'contact-form' - enviado via AJAX (formIndex.js)
        - Campos do formulário com IDs específicos (name, company, email, phone, location, service, description)
        - Os dados são enviados para app/controllers/process_form.php via jQuery Ajax
        - Validação HTML5 com atributo 'required'
    -->
    <section id="contato" class="hero-bg min-h-screen flex items-center pt-16">
        <div class="container mx-auto px-4 py-20">
            
            <!-- Layout de duas colunas: Texto explicativo + Formulário -->
            <div class="flex flex-col lg:flex-row items-center justify-between gap-12">
                ...
                <div class="lg:w-1/2 w-full">
                    <!-- Card com efeito glassmorphism (backdrop-blur) -->
                    <div class="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-lg shadow-xl text-white">
                        
                        <!-- Formulário - ID 'contact-form' manipulado por formIndex.js -->
                        <!-- Ao submeter, o JavaScript previne o comportamento padrão e envia via AJAX -->
                        <form id="contact-form">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <!-- Campo 'name' - valor será capturado e enviado para o backend -->
                                ...
                                <div>
                                    ...
                                    <!-- Campo 'company' - enviado para process_form.php -->
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <!-- Campo 'email' - validação HTML5 type="email" -->
                                ...
                                <div>
                                    ...
                                    <!-- Campo 'phone' - type="tel" para teclado numérico em mobile -->
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <!-- Campo 'service' - tipo de serviço solicitado -->
                            ...
                            <div class="mb-6">
                                ...
                                <!-- Campo 'description' - textarea para descrição longa -->
                            ...
                            <div class="text-center">
                                <!-- type="submit" - ao clicar, dispara evento 'submit' do formulário -->
                                <!-- formIndex.js intercepta este evento e envia os dados via AJAX -->
    ...
    <!-- ========================================
        RODAPÉ / FOOTER
        ========================================
        Rodapé do site com informações da empresa.
        Grid de 3 colunas: Descrição + Links + Contato
    -->
    ...
    <!-- ========================================
         MODAL DE RESULTADO DO FORMULÁRIO
         ========================================
         Modal exibido após envio do formulário de contato.
         Elementos importantes:
         - ID 'modal-overlay' - container do modal (inicialmente hidden)
         - ID 'result-modal' - card do modal
         - ID 'modal-title' - título dinâmico (sucesso ou erro)
         - ID 'modal-message' - mensagem dinâmica retornada do servidor
         - ID 'close-form-modal' - botão para fechar o modal
         
         Manipulado por formIndex.js que:
         1. Exibe o modal após resposta do servidor
         2. Preenche título e mensagem dinamicamente
         3. Fecha ao clicar no botão ou fora do modal
    -->
    <div id="modal-overlay" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 hidden">
        <div id="result-modal" class="bg-white p-8 rounded-lg shadow-2xl max-w-sm w-full text-center relative">
            <!-- Título preenchido dinamicamente via JavaScript -->
            <h3 id="modal-title" class="text-2xl font-bold mb-4"></h3>
            
            <!-- Mensagem preenchida dinamicamente via JavaScript -->
    ...
    <!-- ========================================
        SCRIPTS EXTERNOS E INTERNOS
        ========================================
        Carregamento de bibliotecas e scripts customizados
    -->
    
    <!-- jQuery - biblioteca JavaScript para manipulação DOM e AJAX -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    
    <!-- index.js - Controla menu mobile, carrossel de depoimentos e scroll suave -->
    <script src="../public/assets/js/index.js"></script>
    
    <!-- formIndex.js - Gerencia envio do formulário via AJAX -->
    <!-- Captura evento submit, serializa dados e envia para process_form.php -->
    <script src="../public/assets/js/formIndex.js"></script>
    
    <!-- ========================================
        INTERSECTION OBSERVER - ANIMAÇÕES ON SCROLL
        ========================================
        Script inline para animações ao rolar a página.
        
        COMO FUNCIONA:
        1. Espera o DOM estar completamente carregado (DOMContentLoaded)
        2. Cria um IntersectionObserver que monitora elementos na viewport
        3. Quando um elemento com classe 'js-scroll-animate' entra na viewport:
            - Remove classes 'opacity-0' e 'translate-y-5'
            - Elemento se torna visível e move para posição original
            - Para de observar o elemento (unobserve) para economizar recursos
            ...
            const intersectionCallback = (entries, observer) => {
                ...
                entries.forEach(entry => {
                    ...
                    if (entry.isIntersecting) {
                        // Remove classes que ocultam/deslocam elemento
                        entry.target.classList.remove('opacity-0', 'translate-y-5');
                        
                        // Para de observar este elemento (otimização)
                        observer.unobserve(entry.target);
                    }
                });
            };

            // Cria o observer com as configurações e callback

            // Cria o observer com as configurações e callback
            const observer = new IntersectionObserver(intersectionCallback, observerOptions);

            // Seleciona todos os elementos com classe 'js-scroll-animate'
            const targets = document.querySelectorAll('.js-scroll-animate');
            
            // Inicia observação de cada elemento
