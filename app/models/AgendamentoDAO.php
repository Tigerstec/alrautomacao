...
class agendamentoDAO {
    ...
    public function create($data) {
        ...
        $stmt->execute([$data['client'], $data['phone'], $data['serviceId'], $data['date'], $data['time'], $data['status'], $data['notes']]);
    ...
    public function update($id, $data) {
        ...
        return $stmt->execute([$data['client'], $data['phone'], $data['serviceId'], $data['date'], $data['time'], $data['status'], $data['notes'], $id]);
    }
